...
export const en: typeof zh = {
  ...
  manager: {
    ...
    shareDesc: 'Scan this set of animated QR codes with another device, or export them as an animation.',
    exportAnim: 'Export animation',
    exportUnsupported: 'Not supported in this browser',
    exporting: 'Exporting…',
    importTitle: 'Import score',
    importScan: 'Point the camera at the animated QR codes until every segment lights up, or upload a QR animation.',
    importUpload: 'Upload image / animation',
  ...
  workbench: {
    ...
    downloadQr: 'Share via QR',
    editorTitle: 'Score editor',
    hintsTitle: 'Syntax hints',
    controlsTitle: 'Controls',
    pianoRollTitle: 'Piano roll',
    visualizer: 'Score visualization',
    jianpuTitle: 'Numbered score',
    jianpuHint: 'Click a note to seek · 4 measures per system',
    jianpuVoice: 'Voice {{ number }}',
    jianpuChordTrack: 'Chord voice',
    jianpuChordShort: 'C',
    jianpuRestLabel: 'Rest',
    jianpuEndMark: 'Final barline',
    ...
    pianoJudgeLine: 'Judge line (on keys ↔ floating · waterfall)',
    pianoCenter: 'Editor & score preview side-by-side',
    ...
    tracks: 'Tracks',
    measures: 'Measures',
    measureBeat: 'Measure {{ measure }} · Beat {{ beat }}',
    metronomeOn: 'Turn metronome on',
    metronomeOff: 'Turn metronome off',
    key: 'Key',
    tempo: 'Tempo',
    duration: 'Duration',
