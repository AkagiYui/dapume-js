...
export const en: typeof zh = {
  ...
  manager: {
    ...
    shareDesc: 'Scan this set of animated QR codes with another device to import the score.',
    importTitle: 'Import score',
    importScan: 'Point the camera at the animated QR codes until every segment lights up.',
